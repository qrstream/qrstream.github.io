...
module.exports = require('./src/qrstream');

},{"./src/qrstream":9}],3:[function(require,module,exports){
...
var qrstream = function () {
  var qrstream = function (qrCapacity, qrWidth) {
    var _this = {};
    ...
    const _format = function(content, width) {
      if (!width) {
        width = _this.metadata.qrcode.width;
      }
...
},{"fs":3,"md5":7,"qrcode-generator":8}]},{},[1]);
